...
### Link to Web App: 
https://abbydabbydoodoesgithub.github.io/reactportfolioapp/

### App Preview:
![My Password Generator Screenshot](./src/assets/imgs/MyPortfolioScreenShot.png "My Password Generator Screenshot")
...
Getting the github deployment up proved a bit tricky, and I ended up creating a new repo to resolve the deployment challenges. Once the fresh repo's deployment was working, I copied the src file form the original repo into the new one. You can see the original repo [here](https://github.com/AbbyDabbyDooDoesGitHub/UW_ChWk20_ReactPortfolio).
...
<!--! links to both the deployed applications and the corresponding GitHub repository -->
